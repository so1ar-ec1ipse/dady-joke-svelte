...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Svelte Node App";
    			t1 = space();
    			form = element("form");
    			label = element("label");
    			t2 = space();
    			...
    			dispose = [
    				...
    				listen_dev(
    					...
    					prevent_default(function () {
    						if (is_function(/*handleSubmit*/ ctx[1](/*searchTerm*/ ctx[0]))) /*handleSubmit*/ ctx[1](/*searchTerm*/ ctx[0]).apply(this, arguments);
    					}),
    					false,
    					true,
    					false
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const handleSubmit = () => {
    		...
    		fetch("functions/200.js").then(response => console.log(response));
    	};
    	...
    	return [searchTerm, handleSubmit, input_input_handler];
    }
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*searchTerm*/ ctx[0] === undefined && !("searchTerm" in props)) {
    			console_1.warn("<App> was created without expected prop 'searchTerm'");
    		}
    	}
